...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'allroundi');
...
if( !function_exists('cbv_theme_setup') ){
	...
	function cbv_theme_setup(){
	  ...
	  load_theme_textdomain( 'allroundi', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
            ...
            'cbv_footer_menu_1' => __( 'Footer Menu 1', THEME_NAME ),
            'cbv_footer_menu_2' => __( 'Footer Menu 2', THEME_NAME ),
            'cbv_footer_menu_3' => __( 'Footer Menu 3', THEME_NAME ),
